...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-6 flex justify-between">
      ...
      <ul className={`menu flex items-center sm:gap-10 gap-4 md:static fixed left-1/2 -translate-x-1/2 md:-translate-x-0 md:opacity-100 bg-violet-700 backdrop-blur-md p-4 mt-2 md:mt-0 rounded-4xl md:bg-transparent transition-all md:transition-none ${active ? "top-0 opacity-100" : "-top-10 opacity-0"}`}>
        <li>
